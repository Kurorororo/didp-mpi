...
use dypdl_heuristic_search::search_algorithm::{util::TimeKeeper, BreadthFirstSearch};
    ...
    <T as FromStr>::Err: Debug,
{
    ...
    let parameters = didp_mpi::load_brfs_parameters_from_map::<T>(map);
    ...
    let mut solver =
        BreadthFirstSearch::new(input, transition_evaluator, base_cost_evaluator, parameters);
