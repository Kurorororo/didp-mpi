use didp_mpi::{
    AdditionalCommonParameters, HashType, HdBestFirstSearch, IsFloat, MpiAnytimeSearchParameters,
    ...
    H: Fn(&HashableSignatureVariables) -> u64,
{
    ...
    let mut solver =
        HdBestFirstSearch::new(input, evaluators, parameters, hash_function, &communicator);
