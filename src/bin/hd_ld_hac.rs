use didp_mpi::{
    AdditionalCommonParameters, HashType, HdLdHac, IsFloat, KeyValueStatistics,
    ...
    H: Fn(&HashableSignatureVariables) -> u64,
{
    ...
    let mut solver = HdLdHac::new(input, evaluators, parameters, hash_function, &communicator);
