use didp_mpi::{
    AdditionalCommonParameters, HashType, Hdbrfs3, IsFloat, MpiAnytimeSearchParameters,
    ...
    H: Fn(&HashableSignatureVariables) -> u64,
{
    ...
    let mut solver = Hdbrfs3::new(&input, evaluators, parameters, hash_function, &communicator);
